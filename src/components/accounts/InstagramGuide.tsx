  ...
  <div className="space-y-4 animate-in fade-in duration-200">
    ...
    <div className="space-y-2 p-3.5 rounded-2xl bg-[#131627] border border-white/10 text-xs">
      ...
      <div className="space-y-2 pt-1">
        <CopyField label="Development Redirect URI" value={INSTAGRAM_DEV_CALLBACK_URL} copyKey="igDevUrl" copiedKey={copiedKey} onCopy={onCopy} valueClass="text-pink-300" title="Copy URL" />
        <CopyField label="Shared / Deployed Redirect URI" value={INSTAGRAM_SHARED_CALLBACK_URL} copyKey="igSharedUrl" copiedKey={copiedKey} onCopy={onCopy} valueClass="text-pink-300" title="Copy URL" />
      </div>
    </div>
